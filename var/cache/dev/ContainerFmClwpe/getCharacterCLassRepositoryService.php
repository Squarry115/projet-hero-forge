...
class getCharacterCLassRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CharacterCLassRepository.php';

        return $container->privates['App\\Repository\\CharacterCLassRepository'] = new \App\Repository\CharacterCLassRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
