 ...
 */
class getPartyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PartyRepository' shared autowired service.
     *
     * @return \App\Repository\PartyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PartyRepository.php';

        return $container->privates['App\\Repository\\PartyRepository'] = new \App\Repository\PartyRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
